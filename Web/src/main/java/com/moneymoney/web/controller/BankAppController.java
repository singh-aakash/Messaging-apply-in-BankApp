...
public class BankAppController {
	...
	public String TransferFundbreaker(@RequestParam("senderAccountNumber") int senderAccountNumber,
			@RequestParam("receiverAccountNumber") int ReceiverAccountNumber,
	...
	@HystrixCommand(fallbackMethod = "GetStateMentbreaker")
	...
	public ModelAndView GetStateMentbreaker(@RequestParam("offset") int offset, @RequestParam("size") int size) {

		return new ModelAndView("getStatement","message", "Transaction can't be completed right now!");
	}
